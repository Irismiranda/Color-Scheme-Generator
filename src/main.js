                        ...
                        <div class='color-code'>
                            <div class='color-data-container'>
                               ...
                               <div class='flex center'> 
                                    ...
                                    <div onClick={() => copyToClipboard(${hexValue})} class='clipboard'>
...
function copyToClipboard(hexValue){
    ...
    try {
        ...
        document.getElementById(hexValue).classList.remove('invisible')
        setTimeout(function () {
            document.getElementById(hexValue).classList.add('invisible')
        }, 2000)
    } catch (err) {
